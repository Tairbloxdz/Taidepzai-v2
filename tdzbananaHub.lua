...
local Window = OrionLib:MakeWindow({Name = "taidepzai  Hub",IntroText = "taidepzai  Library"})
...
local FolderName = "taidepzai  Hub"
...
function HopServer()
    ...
    v14.new("<Color=Red>taidepzai Hub : Wait "..(tostring(Settings["Delay HopServer"]) or "15").."s[Hop Server]<Color=/>"):Display()
    while wait(Settings["Delay HopServer"] or 15) do
        local v14 = require(game:GetService("ReplicatedStorage").Notification)
        v14.new("<Color=Red>taidepzai Hub : Hop Server<Color=/>"):Display()
        Hop()
    end
end
		...
		["embeds"] = {
			{
                ...
                ["image"] = {
                    ["url"] =  "https://media.discordapp.net/attachments/1303245126990172192/1309149556679774218/Screenshot_2024-11-14-21-43-56-032_com.google.android.apps.photos.jpg?ex=67408809&is=673f3689&hm=7e2b8d5bf7f555b90317ee2ff7452c82078e407cf8205f0389662949dc53fda5&"
                },
                ["footer"] = {
                    ["text"] = "https://discord.gg/YEVuc9RvmB",
                    ["icon_url"] = "https://media.discordapp.net/attachments/1303245126990172192/1309149556679774218/Screenshot_2024-11-14-21-43-56-032_com.google.android.apps.photos.jpg?ex=67408809&is=673f3689&hm=7e2b8d5bf7f555b90317ee2ff7452c82078e407cf8205f0389662949dc53fda5&"
                },
